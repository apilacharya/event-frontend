    ...
    <PageWrapper>
      <div className="grid gap-6 md:grid-cols-2 md:items-stretch">
        <Stack spacing={3}>
          ...
          <Typography color="text.secondary">Start organizing and sharing your events.</Typography>
          ...
          >
            ...
            />
            <Button type="submit" variant="contained" color="primary" disabled={signupMutation.isPending}>
